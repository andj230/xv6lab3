...
stat(const char *n, struct stat *st)
{
 ...
 164:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 166:	85ca                	mv	a1,s2
 168:	1b8000ef          	jal	320 <fstat>
 16c:	892a                	mv	s2,a0
  close(fd);
 16e:	8526                	mv	a0,s1
 170:	180000ef          	jal	2f0 <close>
  return r;
 174:	64a2                	ld	s1,8(sp)
}
 176:	854a                	mv	a0,s2
