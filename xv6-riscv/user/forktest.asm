...
forktest(void)
{
  ...
  36:	3fe50513          	addi	a0,a0,1022 # 430 <uptime+0xc>
  ...
  58:	42c50513          	addi	a0,a0,1068 # 480 <uptime+0x5c>
  5c:	fa5ff0ef          	jal	0 <print>
    exit(1);
  60:	4505                	li	a0,1
  62:	32a000ef          	jal	38c <exit>
      exit(0);
  66:	326000ef          	jal	38c <exit>
  }
  ...
  6e:	3d650513          	addi	a0,a0,982 # 440 <uptime+0x1c>
  72:	f8fff0ef          	jal	0 <print>
      exit(1);
  76:	4505                	li	a0,1
  78:	314000ef          	jal	38c <exit>
    }
  }
  ...
  80:	3dc50513          	addi	a0,a0,988 # 458 <uptime+0x34>
  84:	f7dff0ef          	jal	0 <print>
    exit(1);
  88:	4505                	li	a0,1
  8a:	302000ef          	jal	38c <exit>
  for(; n > 0; n--){
  ...
  b0:	3c450513          	addi	a0,a0,964 # 470 <uptime+0x4c>
